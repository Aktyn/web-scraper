...
import {
  ...
  type ParsedScraperExecutionTree,
  parseScraperExecutionAsTree,
} from './helpers'

describe(parseScraperExecutionAsTree.name, () => {
  it('should parse scraper execution as tree', () => {
    const tree = parseScraperExecutionAsTree(executionMock)
    expect(tree).toEqual(executionTreeMock)
  })
})
