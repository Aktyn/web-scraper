...
sed -i 's/return require(`@libsql\/${target}`);/const sea = require("node:sea")\
...
\
return require("node:module").createRequire(__filename)(__dirname + "\/libsql");/g' ./apps/backend/dist/standalone-copy.js
